...
export async function seedDemoDataIfEmpty(): Promise<void> {
  ...
  const jobs: Job[] = [
    ...
    },
    {
      ...
      notes: 'Burgundy color with gold trim.',
      createdAt: now,
      updatedAt: now,
    },
    {
    ...
    },
    {
      ...
      style: 'Grand Buba',
      fabric: 'Damask',
      deliveryDate: addDaysISO(-2), // overdue
      price: 55000,
      deposit: 25000,
      balance: 30000,
      status: 'Finishing',
    ...
    },
    {
      ...
      fabric: 'Silk',
      deliveryDate: addDaysISO(-5), // overdue, delivered
      price: 28000,
      deposit: 28000,
      balance: 0,
      status: 'Delivered',
  ...
  const notifications = [
    {
      ...
      title: "Daniel's Agbada is overdue by 2 days.",
      message: "Daniel Johnson's Agbada was due 2 days ago. Update the status or contact the customer.",
      jobId: jobs[0].id,
      customerId: customers[0].id,
      read: false,
      createdAt: now,
    },
    {
      ...
      title: "Grace's gown is due tomorrow.",
      message: "Grace Okafor's gown delivery is tomorrow. Make sure it's ready.",
      jobId: jobs[1].id,
      customerId: customers[1].id,
      read: false,
      createdAt: now,
    },
    {
      ...
      title: "James' fitting appointment today at 3:00 PM.",
      message: "Reminder: James Nwosu's senator suit is due today.",
      jobId: jobs[2].id,
      customerId: customers[2].id,
      read: false,
      createdAt: now,
    },
    {
      ...
      title: "Samuel's suit marked as completed.",
      message: "Samuel Ike's suit has been marked as delivered.",
      jobId: jobs[7].id,
      customerId: customers[5].id,
      read: true,
      createdAt: now,
    },
    {
      ...
      title: "Payment received from Blessing Sunday.",
      message: "₦12,000 deposit received for Blessing Sunday's Aso-ebi Gown.",
      jobId: jobs[4].id,
      customerId: customers[4].id,
      read: true,
      createdAt: now,
